  ...
  >
    <div className="panel">
      <span>
        ...
        gives you a new mystery student to find each day and reset at 19:00 UTC
        (the same time as Blue Archive). In Endless mode, you can play as much
        as you want.
      </span>
      <span>
      ...
      <span>
        After <b>5</b> attempts, you can select <b>Give Up</b> at the bottom of
        the screen to reveal the answer.
      </span>
      <span>
      ...
      <small>
        ...
        column, so I will keep the current format until I come up with a better
        idea.
      </small>
      <small>
        I created this website as a hobby and do not earn any revenue from it.
        The purpose of this site is to have fun. All assets on this website are
        the copyright of their respective authors. If you're interested in the
        source code, I open public on my{" "}
        <a
...
export const MoreProjectModal = ({ modalStatus, setModalStatus }) => (
  ...
  >
    <div className="panel">
      ...
      <span>
        I also created another website where you can <b>save</b> and{" "}
        <b>share</b> your Blue Archive students. Check it out at{" "}
        <a
          href="https://bamystudents.netlify.app"
          rel="noopener noreferrer"
          target="_blank"
        >
          https://bamystudents.netlify.app
        </a>
      </span>
    </div>
  </Modal>
